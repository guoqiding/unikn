...
seecol <- function(pal = "unikn_all",  # which palette to output?
                   ...
                   labels = NULL,   # add a way to change the labels for shown palettes
  ...
  if (length(pal_tmp) > 1) {
    ...
    text(x = 0, y = 1:length(pal_tmp), labels = ifelse(labels!=NULL, rev(labels), rev(pal_nm)), # add a way to change the labels for shown palettes
